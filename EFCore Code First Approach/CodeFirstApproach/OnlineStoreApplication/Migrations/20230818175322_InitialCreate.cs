    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderProductMappingID = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "(newid())"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderProductMappings", x => x.OrderProductMappingID);
                    table.ForeignKey(
