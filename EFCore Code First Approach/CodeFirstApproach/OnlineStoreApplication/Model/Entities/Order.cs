...
namespace OnlineStoreApplication.Entities
{
    public class Order
    {
        public Guid OrderID { get; set; } //Unique identifier for each order.
        public DateTime OrderDate { get; set; } //Date when the order was placed.

        public Guid CustomerID { get; set; } //It is a foreign key property that references the primary key (CustomerID) of the Customer entity.
